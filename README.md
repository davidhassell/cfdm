...
The `cfdm` package uses [Dask](https://docs.dask.org) for all of its
data manipulations.
...
* read field and domain constructs from netCDF, CDL, Zarr, Kerchunk,
  PP and UM with a choice of backends, and in local, http, and s3
  locations,
...
* write and append field and domain constructs to netCDF and Zarr v3
  datasets on disk, with control over HDF5 internal metadata,
