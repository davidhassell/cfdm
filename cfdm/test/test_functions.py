...
class FunctionsTest(unittest.TestCase):
    ...
    def setUp(self):
        # Disable log messages to silence expected warning, but save
        # original state for test on logging (see test_LOG_LEVEL)
    ...
    def test_reset_log_emergence_level(self):
        ...
        # Now test 'DISABLE' (0) special case; should not change level
        # as such
