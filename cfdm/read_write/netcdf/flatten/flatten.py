...
class _Flattener:
    ...
    def flatten(self):
        ...
        logging.debug(f"Flattening the groups of {self.filepath(input_ds)}")
    ...
    def process_group(self, input_group):
        ...
        """
        logging.debug(f"    Browsing group {self.path(input_group)}")
    ...
    def flatten_variable(self, var):
        ...
        logging.debug(f"        Creating variable {new_name} from {fullname}")
