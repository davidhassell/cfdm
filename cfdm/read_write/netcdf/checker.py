...
class NetCDFCheckerMixin(Report):
    ...
    def _check_field_ncvar(self, field_ncvar):
        ...
        self._check_standard_names(
            field_ncvar,
            field_ncvar,
            self.read_vars["variables"][field_ncvar].attrs,
        )
    ...
    def _check_geometry_node_coordinates(
        ...
        geometry_ncvar_attrs = self.read_vars["variables"][
            geometry_ncvar
        ].attrs
        self._check_standard_names(
            node_ncvar,
    ...
    def _check_cell_measures(self, field_ncvar, string, parsed_string):
        ...
        * 7.2.requirement.4
        ...
        for x in parsed_string:
            ...
            # For external variables, the variable will not be in
            # covered in read_vars["variables"], so in this case we
            ...
            # cf-conventions.html#external-variables in case this
            # changes).
            var = self.read_vars["variables"].get(ncvar)
            if var is not None:
    ...
    def _check_tie_point_coordinates(
        ...
        * 8.3.requirement.5
        ...
        tie_point_ncvar_attrs = g["variables"][tie_point_ncvar].attrs
        self._check_standard_names(
            parent_ncvar,
            tie_point_ncvar,
    ...
    def _check_node_coordinates(
        ...
        geometry_ncvar_attrs = g["variables"][geometry_ncvar].attrs
        self._check_standard_names(
            field_ncvar,
            geometry_ncvar,
            geometry_ncvar_attrs,
    ...
    def _check_coordinate_interpolation(
        ...
        for interp_ncvar, coords in parsed_coordinate_interpolation.items():
            interp_ncvar_attrs = g["variables"][interp_ncvar].attrs
            self._check_standard_names(
                parent_ncvar,
                interp_ncvar,
                interp_ncvar_attrs,
            ...
            for tie_point_ncvar in coords:
                tie_point_interp_ncvar_attrs = g["variables"][
                    tie_point_ncvar
                ].attrs
                self._check_standard_names(
                    parent_ncvar,
    ...
    def _ugrid_check_location_index_set(
        ...
        mesh_ncvar_attrs = g["variables"][mesh_ncvar].attrs
        self._check_standard_names(
            location_index_set_ncvar,
            mesh_ncvar,
            mesh_ncvar_attrs,
    ...
    def _ugrid_check_field_location_index_set(
        ...
        loc_index_dims = g["variable_dimension_paths"][
            location_index_set_ncvar
        ]
    ...
    def _ugrid_check_connectivity_variable(
        ...
        ncvar_attrs = g["variables"][connectivity_ncvar].attrs
        self._check_standard_names(
            parent_ncvar,
            connectivity_ncvar,
            ncvar_attrs,
