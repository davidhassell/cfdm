...
class NetCDFRead(IORead):
        ...
        if not self._cfa_is_aggregation_variable(ncvar):
            ...
            if netcdf_backend.startswith("h5netcdf"):
                if netcdf_backend.endswith("pyfive"):
                    ...
                    #
                    # Get the relevant pyfive.Variable object and
                    # store it inside the Array object
    ...
    def _index(self, variable, index):
        ...
        :Parameters: TODOVAR
            ...
            nc:
                The dataset. One of `netCDF4.Dataset`,
                `scipy.io.netcdf_file`, or `h5netcdf.File`. TODOVAR

            attr: `str`
                The global attribute name. TODOVAR

        :Returns:

                The global attribute value. TODOVAR
    ...
    def _netcdf_chunksizes(self, variable):
        ...
        variable:
                ...
                `netCDF4.Variable` or `h5netcdf.Variable`. TODOVAR
