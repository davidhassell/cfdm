...
class DatasetArray(IndexMixin, abstract.Array):
    ...
    def _get_array(self, index=None):
        ...
        with lock:
            ...
            if variable is None:                
                dataset = self.open()
                variable = dataset.variables[self.get_address()]
    ...
    def open(self, **kwargs):
        ...
        dataset = self.get_filename(normalise=True)
