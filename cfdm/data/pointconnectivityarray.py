from ..subarray import PointConnectivitySubarray
from .abstract import ConnectivityArray


class PointConnectivityArray(ConnectivityArray):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        instance._Subarray = {
            "point connectivity": PointConnectivitySubarray,
        }
        return instance
    ...
    def __init__(
        ...
        super().__init__(
            ...
            compression_type="point connectivity",
            source=source,
            copy=copy,
        )
