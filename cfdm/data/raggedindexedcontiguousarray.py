...
class RaggedIndexedContiguousArray(RaggedArray):
    ...
    #            # in the profile
    #            xprofile_indices = np.where(index_array == i)[0]
    #
    ...
    def subarrays(self):
        ...
        shapes = [(n,) for n in uncompressed_shape]
        shapes[u_dim1] = (1,) * n_features
        shapes[u_dim2] = (1,) * max_n_profiles

        # The indices of the compressed array that correspond to each
        # subarray
        indices = [(slice(None),)] * self.source().ndim
