...
class TiePoint(mixin.NetCDFVariable,
               mixin.Coordinate,
               core.abstract.Coordinate):
    '''A tie point variable required to uncompress a sampled array TODO.
    ...
    **NetCDF interface**
    ...
    def dump(self, display=True, _key=None, _title=None,
        ...
        '''A full description of the tie point variable.
    ...
    :Returns:
        ...
        if _create_title and _title is None:
            _title = 'TiePoint: ' + self.identity(default='')
